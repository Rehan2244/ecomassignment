...
import { loading, searchNowAction } from "../redux/actions";
    ...
    <div className="header">
      <div className="headerContainer">
        ...
        <div className="icons cursor-pointer">
          <Button
            style={{ color: "#fff", marginRight: "30px", zIndex: 99999 }}
            onClick={() => logout()}
          >
            Logout
          </Button>
          <div id="icon" className="icon">
            <Badge
              ...
              badgeContent={cart.cartItems.length ? cartItem.totalCartItems : 0}
              color="primary"
            >
